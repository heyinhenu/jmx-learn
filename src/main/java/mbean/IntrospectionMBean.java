 ...
 * 将其封装成一个{@link javax.management.DynamicMBean}.
 *
...
public class IntrospectionMBean implements DynamicMBean {
     ...
     *
     * @exception javax.management.NotCompliantMBeanException 内省时发生异常
     *
     ...
     * @throws javax.management.NotCompliantMBeanException 内省时发生异常
     *
    ...
    /**
     * 内省mbean生成{@link javax.management.MBeanInfo}信息.
     *
     * @param mbeanImpl mbean实现类实例
     * @param mbeanInterface mbean接口
     * @return 内省mbean生成的{@link MBeanInfo}信息
     * @throws javax.management.NotCompliantMBeanException 内省mbean发生错误时抛出此异常
     */
    ...
    /**
     * 根据属性名称建立{@link javax.management.Attribute}.
     *
     ...
     * @return 属性值.
     *
     * @exception javax.management.AttributeNotFoundException 当找不到属性的getter方法时，将抛出此异常
     * @exception javax.management.MBeanException 发生未知错误时，将抛出此异常
     * @exception javax.management.ReflectionException 当调用属性的getter方法发生错误时，将抛出此异常
     */
